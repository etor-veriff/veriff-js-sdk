...
```html
<script src="https://cdn.veriff.me/sdk/js/2.0/veriff.min.js"></script>
```
...
In order to initialize the library, _API Key_, _parentId_ and _onSession_ callback function is required.
...
_onSession_ function is executed after the _response_ is received from the API, response body contains a verification object with following schema:
